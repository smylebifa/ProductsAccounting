#pragma checksum "E:\ilia\Web\ProductsAccountingNew\ProductsAccountingNew\Views\Authentication\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "341d64b1d5c6e9d3b220cdbd1a93f5500ef17214"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"341d64b1d5c6e9d3b220cdbd1a93f5500ef17214", @"/Views/Authentication/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "341d64b1d5c6e9d3b220cdbd1a93f5500ef172144211", async() => {
                WriteLiteral(@"
...
#line 104 "E:\ilia\Web\ProductsAccountingNew\ProductsAccountingNew\Views\Authentication\Index.cshtml"
    ...
    else if (@ViewBag.Status == "successRegistration")
    {
...
#nullable disable
            WriteLiteral(@"        <script type=""text/javascript"">
            $.get(this.href, function (data) {
                $('#dialogContent').html('<div class=""modal-content""> <div class=""modal-header""><h4>Результат</h4><button class=""close"" data-dismiss=""modal"" area-hidden=""true"">x</button></div><div class=""modal-body""> <dl class=""dl-horizontal""> <dt>Статус:</dt> <dd>Регистрация прошла успешна. Для входа введите данные регистрации.</dd> </dl> </div> </div>');
                $('#modDialog').modal('show');
            });
        </script>
");
#nullable restore
#line 114 "E:\ilia\Web\ProductsAccountingNew\ProductsAccountingNew\Views\Authentication\Index.cshtml"
    }
